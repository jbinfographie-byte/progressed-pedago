...
export async function GET() {
  try {
    ...
    return jsonOk({
      ...
      unlimited: entitlement.subscription.unlimited,
      voice: {
        ...
        remainingSeconds: entitlement.subscription.unlimited ? null : Math.max(0, entitlement.monthlyVoiceLimit - entitlement.subscription.voiceSecondsMonth),
      },
      credits: { available: entitlement.subscription.unlimited ? null : entitlement.creditsAvailable },
