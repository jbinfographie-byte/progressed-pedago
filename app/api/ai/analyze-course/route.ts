...
export async function POST(request:Request){
  ...
  try{
    ...
    if(!config)return Response.json({error:"La connexion à l’intelligence artificielle n’est pas encore configurée. L’administrateur doit ajouter la clé OpenAI dans les réglages du site."},{status:503});
