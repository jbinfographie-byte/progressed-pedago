...
import { coursePagesJsonSchema, normalizeCourseLength, normalizeCoursePages, resolveCoursePageCount, validateCoursePages } from '@/lib/course-pages';
...
export async function POST(request: Request) {
  try {
    ...
    let parsed: { activities: Array<Omit<ActivityDraft, 'content'> & { contentJson: string; coursePages?:unknown }> };
