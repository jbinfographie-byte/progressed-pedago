...
type PrintOptions={showResultZone:boolean;showSolutions:boolean;showExplanations:boolean;showSources:boolean;showImage:boolean};
...
function PrintPreview({activity,onClose}:{activity:Activity;onClose:()=>void}){
  const [options,setOptions]=useState<PrintOptions>({showResultZone:false,showSolutions:true,showExplanations:true,showSources:true,showImage:true});
